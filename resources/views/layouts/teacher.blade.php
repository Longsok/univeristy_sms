...
<head>
    ...
    <title>@yield('title', 'Teacher') — RUPP SMS</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .sidebar-brand-text .title {
            font-family: 'Hanuman', serif; font-size: 13px; font-weight: 700;
            color: var(--rupp-gold); display: block;
        }
        ...
        .sidebar-role-badge {
            ...
            color: var(--rupp-gold); letter-spacing: .05em; text-transform: uppercase;
        }
        ...
        .sidebar-user-avatar {
            ...
            font-size: 13px; font-weight: 600; color: var(--rupp-green-dark);
        ...
        .sidebar-logout { background: none; border: none; padding: 4px; color: rgba(255,255,255,0.4); cursor: pointer; font-size: 16px; transition: color .15s; }
        ...
        .topbar-date { font-size: 12px; color: #6b7280; }
        .page-content { padding: 28px; flex: 1; }

        /* Shared component styles (same as admin layout) */
        ...
        .table-rupp thead th { background: #f9fafb; padding: 10px 14px; font-size: 11px; font-weight: 600; letter-spacing: .05em; text-transform: uppercase; color: #6b7280; border-bottom: 1px solid #e5e7eb; white-space: nowrap; }
        ...
        .btn-rupp-primary { background: var(--rupp-green); color: #fff; border: none; padding: 8px 18px; border-radius: 8px; font-size: 13.5px; font-weight: 500; cursor: pointer; display: inline-flex; align-items: center; gap: 6px; text-decoration: none; transition: background .15s; }
        .btn-rupp-primary:hover { background: var(--rupp-green-light); color: #fff; }
        .btn-rupp-gold { background: var(--rupp-gold); color: var(--rupp-green-dark); border: none; padding: 8px 18px; border-radius: 8px; font-size: 13.5px; font-weight: 600; cursor: pointer; display: inline-flex; align-items: center; gap: 6px; text-decoration: none; }
        ...
        .btn-icon { width: 32px; height: 32px; border-radius: 6px; display: inline-flex; align-items: center; justify-content: center; font-size: 15px; border: none; cursor: pointer; text-decoration: none; transition: background .15s; }
...
<aside class="sidebar">
    ...
    <div class="sidebar-section-label">Grades & Reports</div>
    <ul class="sidebar-nav">
        <li>
            <a href="{{ route('teacher.courses.index') }}"
        ...
        <li>
            <a href="{{ route('teacher.courses.index') }}"
            class="{{ request()->routeIs('teacher.reexam.*') ? 'active' : '' }}">
        ...
        <li>
            <a href="{{ route('teacher.courses.index') }}"
               class="{{ request()->routeIs('teacher.reports.*') ? 'active' : '' }}">
                <i class="bi bi-bar-chart-line"></i> Grade Reports
            </a>
        </li>
        <li>
            <a href="{{ route('teacher.courses.index') }}"
               class="{{ request()->routeIs('teacher.groups.*') ? 'active' : '' }}">
    ...
    <div class="sidebar-footer">
        <div class="sidebar-user">
            ...
            <div class="sidebar-user-info">
                ...
                <div class="role">
                    {{ Auth::user()->teacher?->department?->name ?? 'Teacher' }}
                </div>
            </div>
