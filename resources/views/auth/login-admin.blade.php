...
<head>
    ...
    <title>Admin Login — RUPP SMS</title>
    ...
    <style>
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .role-badge span{font-size:15px;font-weight:600;color:#fff;letter-spacing:.03em;}
        ...
        .card-header .portal-tag{display:inline-flex;align-items:center;gap:6px;background:#fdf3d7;color:#92680a;border-radius:20px;padding:4px 12px;font-size:11.5px;font-weight:600;margin-bottom:12px;}
...
<div class="left">
    ...
    <ul class="features">
        <li><i class="bi bi-people-fill"></i> Manage all students & teachers</li>
        <li><i class="bi bi-building"></i> Faculty & department control</li>
        <li><i class="bi bi-bar-chart-fill"></i> System-wide reports</li>
        <li><i class="bi bi-megaphone-fill"></i> Post announcements</li>
    </ul>
</div>
<div class="right">
    <div class="card">
        ...
        <div class="card-header">
            <div class="portal-tag"><i class="bi bi-shield-fill-check"></i> Administrator</div>
            <h2>Admin Sign In</h2>
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    ...
                    <input type="email" name="email" class="form-input {{ $errors->has('email') ? 'err' : '' }}"
                        value="{{ old('email') }}" placeholder="admin@university.edu" autofocus required>
                </div>
            </div>
            <div class="form-group">
