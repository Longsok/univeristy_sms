...
<head>
    ...
    <title>Student Login — RUPP SMS</title>
    ...
    <style>
        :root { --green:#1e4d2b; --gd:#163820; --gold:#c9a227; }
        *{box-sizing:border-box;margin:0;padding:0;}
        body{font-family:'Inter',sans-serif;min-height:100vh;display:flex;background:#f3f4f6;}
        .left{width:42%;background:var(--gd);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:60px 40px;position:relative;overflow:hidden;}
        .left::before{content:'';position:absolute;width:400px;height:400px;border:1px solid rgba(201,162,39,0.15);border-radius:50%;top:-100px;right:-100px;}
        .left::after{content:'';position:absolute;width:280px;height:280px;border:1px solid rgba(201,162,39,0.1);border-radius:50%;bottom:-80px;left:-80px;}
        .logo{width:80px;height:80px;margin-bottom:20px;filter:drop-shadow(0 4px 12px rgba(0,0,0,.3));}
        .left h1{font-family:'Hanuman',serif;font-size:20px;font-weight:700;color:var(--gold);text-align:center;line-height:1.4;margin-bottom:6px;}
        .left .sub{font-size:12px;color:rgba(255,255,255,0.5);text-align:center;margin-bottom:32px;}
        .role-badge{background:rgba(201,162,39,0.15);border:1px solid rgba(201,162,39,0.4);border-radius:30px;padding:8px 24px;display:flex;align-items:center;gap:10px;margin-bottom:32px;}
        .role-badge i{font-size:22px;color:var(--gold);}
        .role-badge span{font-size:15px;font-weight:600;color:#fff;}
        .features{list-style:none;width:100%;max-width:260px;}
        .features li{display:flex;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid rgba(255,255,255,0.07);font-size:12.5px;color:rgba(255,255,255,0.6);}
        .features li:last-child{border-bottom:none;}
        .features li i{color:var(--gold);font-size:14px;flex-shrink:0;}
        ...
        .card-header .portal-tag{display:inline-flex;align-items:center;gap:6px;background:#dcfce7;color:#166534;border-radius:20px;padding:4px 12px;font-size:11.5px;font-weight:600;margin-bottom:12px;}
        ...
        .form-input:focus{border-color:var(--green);box-shadow:0 0 0 3px rgba(30,77,43,.12);}
        ...
        .btn-login{width:100%;padding:11px;background:var(--green);color:#fff;border:none;border-radius:8px;font-size:14px;font-weight:600;cursor:pointer;font-family:'Inter',sans-serif;transition:background .15s;margin-top:20px;display:flex;align-items:center;justify-content:center;gap:8px;}
        .btn-login:hover{background:#2a6b3c;}
        .switch-links{margin-top:20px;padding-top:16px;border-top:1px solid #f3f4f6;text-align:center;font-size:12px;color:#9ca3af;}
        .switch-links a{color:var(--green);text-decoration:none;font-weight:500;}
...
<div class="left">
    ...
    <ul class="features">
        <li><i class="bi bi-book-fill"></i> View enrolled courses</li>
        <li><i class="bi bi-record-circle"></i> See Record attendance</li>
        <li><i class="bi bi-file-earmark-text-fill"></i> Download transcript</li>
        <li><i class="bi bi-calendar3-week-fill"></i> View timetable</li>
    </ul>
</div>
<div class="right">
    <div class="card">
        ...
        <div class="card-header">
            <div class="portal-tag"><i class="bi bi-mortarboard-fill"></i> Student</div>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    ...
                    <input type="email" name="email" class="form-input {{ $errors->has('email') ? 'err' : '' }}"
                        value="{{ old('email') }}" placeholder="student@university.edu" autofocus required>
                </div>
            </div>
            <div class="form-group">
            ...
            <button type="submit" class="btn-login">
                <i class="bi bi-box-arrow-in-right"></i> Sign In as Student
            </button>
        </form>
 
        <div class="switch-links">
            Not a student?
            <a href="{{ route('teacher.login') }}">Teacher Login</a><br>
